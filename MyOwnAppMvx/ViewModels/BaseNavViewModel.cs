...
{
    public class BaseNavViewModel : MvxNavigationViewModel
    {
        ...
        public BaseNavViewModel(ILoggerFactory logFactory, IMvxNavigationService navigationService) : base(logFactory, navigationService)
        {
